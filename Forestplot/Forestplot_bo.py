...
class ForestPlotter:
    ...
    def plot_forest(self, channel='Fp1'):
        # 读取数据
        data = pd.read_csv('./bo_save_csv/data/process_frequency_distribution_median.tsv', sep='\t')
        ...
        # 保存图形和数据
        plt.savefig(f'./bo_save_jpg/ForestPlot/{channel}_Forestplot_median.jpg', dpi=300, bbox_inches='tight')
        results_df.to_csv('./bo_save_csv/ForestPlot/features_statistics_ForestPlot_results_median.csv', index=False)
        plt.close()
