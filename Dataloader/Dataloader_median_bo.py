...
class DataLoader:
    ...
    def _process_data(self):
        ...
        for filename in unique_filenames:
            ...
            if self.data_type in ['frequency_distribution', 'pac', 'symmetry','network_features']:
                ...
                elif self.data_type == 'network_features':
                    features = self.feature_columns['network_features']
                    ch_col = 'ch_name'
...
if __name__ == "__main__":
    ...
    data_type = 'pac'#frequency_distribution symmetry pac time-frequency
