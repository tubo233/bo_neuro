...
class PSDAnalysis:
    def __init__(self):
        self.data_path = "bo_save_csv/data/process_time-frequency_median.tsv"
        self.save_psd_path = "./bo_save_jpg/PSD/"
        self.save_ps_path = "./bo_save_jpg/PS/"
        self.save_ratio_path = "./bo_save_jpg/Ratio/"
